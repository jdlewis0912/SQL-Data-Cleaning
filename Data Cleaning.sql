...
-- First thing I did is create a staging table. This is the one I will work in and clean the data. I want a table with the raw data in case something happens
...
-- Now when I am data cleaning I will follow the following steps
...
-- Checking the company oda to confirm
SELECT *
FROM world_layoffs.layoffs_staging
WHERE company = 'Oda'
;
...
-- now that I have this I can delete rows Ire row_num is greater than 2
...
-- when I look at industry it looks like I have some null and empty rows, let's take a look at these
...
-- makes it easy so if there Ire thousands I wouldn't have to manually check them all
...
-- I also noticed the Crypto has multiple different variations. I need to standardize that - changing all to Crypto
SELECT DISTINCT industry
FROM world_layoffs.layoffs_staging2
ORDER BY industry;
